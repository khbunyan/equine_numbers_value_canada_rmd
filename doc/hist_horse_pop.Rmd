...
```{r plot horses, fig.width=10, fig.height=3, fig.cap = "Figure 1. Horse populations by province.", out.width="100%"}
...
province_plot <- horse_pop %>% 
  ...
  xlab("Year") +
  ylab("Number of horses") +
  ggtitle("Historical number of horses in", params$province) +
  facet_grid(~GEO) +
  scale_y_continuous(labels = scales::comma) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
province_plot
